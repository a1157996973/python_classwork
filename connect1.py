...
a=pd.read_csv('weibo_user.csv',header=None,usecols=[0,2,3])
b=pd.read_csv('id_scores.csv',header=None,usecols=[0,1])
...
data.to_csv('weibo_sum.csv',header=False, index=False,mode='a+')
print(1)
